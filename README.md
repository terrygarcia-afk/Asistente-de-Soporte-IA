...
1. Selecciona el módulo correspondiente a tu consulta  
   (Cierres, Cartera, Reportes, AppMovil, ComprarDias, etc.).
2. Escribe tu pregunta en lenguaje natural.
3. Presiona el botón **Submit** para obtener la respuesta generada.
